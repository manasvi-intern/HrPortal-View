...
const Navbar = () => {
  ...
  const dropdownRef = useRef(null); // Use a ref to track the dropdown
    ...
    <nav className="bg-white shadow-lg p-1 fixed top-0 left-0 w-full z-50 font-bold" style={{ fontFamily: "'Inria Sans', sans-serif", color: '#055484' }}>
      <div className="container mx-auto flex items-center justify-between">
        ...
        <div className="hidden md:flex space-x-6 ml-80">
          ...
          <a href="/dashboard" className="hover:text-orange-500" style={{ fontSize: '15px' }}>My Dashboard</a>
          <a href="/current-jobs" className="hover:text-orange-500" style={{ fontSize: '15px' }}>Current Jobs</a>
          <a href="/past-jobs" className="hover:text-orange-500" style={{ fontSize: '15px' }}>Past Jobs</a>
        </div>
