...
const RejectedCandidates = () => {
  ...
  // Access the rejected candidates data passed from the COOApproval page
  const rejectedCandidates = location.state?.rejectedCandidates || [];
    ...
    <div>
      ...
      <div className="container mx-auto mt-10 mb-10 font-sans" style={{ fontFamily: 'Inria Sans, sans-serif' }}>
        <div className="flex items-center justify-between mb-8">
          <h1 className="text-3xl mt-10 font-semibold text-[#055484]">Rejected Candidates</h1>
          <button
        ...
        {rejectedCandidates.length > 0 ? (
          ...
          <p className="text-gray-500 text-center mt-10">No rejected candidates found.</p>
        )}
      </div>
    </div>
  );
